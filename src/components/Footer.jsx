...
function Footer() {
  return (
    <>
      <div className='mt-32 px-14 h-screen'>
        <div className='flex justify-between'>
          <div className='w-1/2 flex flex-col h-full justify-between font-FoundersGrotesk'>
            <div className='heading'>
              <h1 className='uppercase text-[8.5rem] text-[#212121]'>eye-</h1>
              <h1 className='uppercase text-[8.5rem]  leading-4 text-[#212121]'>opening</h1>
            </div>
          </div>

          <div className='w-1/2'>
            <h1 className='uppercase text-[8.5rem] text-[#212121] font-FoundersGrotesk'>presentations</h1>

            <div className='grid grid-cols-2 font-NeueMontreal'>
